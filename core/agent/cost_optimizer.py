...
class CostOptimizer:
    ...
    def _generate_cache_key(self, query: str, context: dict | None = None) -> str:
        """
    ...
    def get_cached_response(self, query: str, context: dict | None = None) -> dict | None:
        """
    ...
    def cache_response(self, query: str, response: dict, context: dict | None = None) -> None:
        """
