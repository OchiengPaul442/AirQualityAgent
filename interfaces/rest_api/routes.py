...
# Streaming endpoint removed - industry best practice is to use observability tools
# (like LangSmith, OpenTelemetry) for agent reasoning traces, not user-facing streams
