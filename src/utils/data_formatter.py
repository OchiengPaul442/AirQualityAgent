...
def format_air_quality_data(data: dict[str, Any], source: str = "unknown") -> dict[str, Any]:
    ...
    if source == "waqi" and "data" in formatted:
        ...
        if "iaqi" in waqi_data and isinstance(waqi_data["iaqi"], dict):
            ...
            if pollutant_info:
                ...
                formatted["data"]["_data_type_note"] = "WAQI API returns AQI values, not raw concentrations. Concentrations are estimated using EPA AQI breakpoints."
    ...
    # Handle OpenMeteo data - their values ARE also concentrations
        ...
        formatted["_data_type_note"] = "OpenMeteo API returns actual pollutant concentrations in µg/m³"
    ...
    numeric_fields = [
        "temperature", "humidity", "pressure", "wind_speed", "dew", "w"
    ]
