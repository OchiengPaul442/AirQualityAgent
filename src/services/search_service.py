...
class SearchService:
    ...
    def search_air_quality_info(self, location: str, max_results: int = 5) -> list[dict[str, str]]:
        ...
        african_countries = [
            ...
            "djibouti", "eritrea", "sudan", "south sudan", "egypt", "libya", "tunisia",
            "algeria", "morocco", "western sahara", "mauritania", "mali", "niger",
            "chad", "senegal", "gambia", "guinea-bissau", "guinea", "sierra leone",
            "liberia", "cote d'ivoire", "burkina faso", "ghana", "togo", "benin",
            "nigeria", "cameroon", "central african republic", "gabon", "congo",
            "democratic republic of congo", "angola", "zambia", "malawi", "mozambique",
            "zimbabwe", "namibia", "botswana", "south africa", "lesotho", "eswatini",
            "madagascar", "comoros", "mauritius", "seychelles", "cape verde",
    ...
    def search_environmental_news(self, topic: str, max_results: int = 5) -> list[dict[str, str]]:
        ...
        africa_keywords = ["africa", "african", "kenya", "uganda", "nigeria", "ghana", "south africa", "egypt", "morocco"]
